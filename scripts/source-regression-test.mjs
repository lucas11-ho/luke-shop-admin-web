...
pass(['0.8.0','0.9.0','0.9.1'].includes(pkg.version),'release is v0.8.0');
...
pass(/Backend v0\.11\.(?:0|1)/.test(read('README.md')),'README pins compatible Backend v0.11.x contract');
