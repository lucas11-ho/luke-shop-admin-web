...
export function VipRedemptionPolicyCard({currency='USD'}){
 ...
 return <VbenCard title="Cashback redemption" description="Store-scoped customer checkout policy. Backend remains authoritative for spendable reward balance, reward validity, policy limits and the final payable amount.">
