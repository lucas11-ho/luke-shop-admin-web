...
const groups=[
 ...
 ['group.system',[['my-profile','My profile',null,'profile','nav.profile'],['settings','Settings','tenant.settings.read','settings','nav.settings'],['access','Access',null,'access','nav.access'],['audit','Audit log','audit.read','audit','nav.audit']]],
];
