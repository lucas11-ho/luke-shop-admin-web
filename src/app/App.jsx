...
import{MenuShortcutsPage}from'../pages/MenuShortcutsPage.jsx';
import{InventoryPage}from'../pages/InventoryPage.jsx';
import{OrdersPage}from'../pages/OrdersPage.jsx';
import{CustomersPage}from'../pages/CustomersPage.jsx';
import{VipLoyaltyPage}from'../pages/VipLoyaltyPage.jsx';
import{VipAnalyticsPage}from'../pages/VipAnalyticsPage.jsx';
...
import{ThemeSystemPage}from'../pages/ThemeSystemPage.jsx';
...
const pages={'/dashboard':DashboardPage,'/operations':OperationsDashboardPage,'/stores':StoresPage,'/my-profile':MyProfilePage,'/driver-messages':DriverMessagesPage,'/driver-access':DriverAccessPage,'/driver-settings':DriverAppSettingsPage,'/delivery-settings':DeliverySettingsPage,'/audit':AuditPage,'/products':ProductsPage,'/categories':CategoriesPage,'/menu-shortcuts':MenuShortcutsPage,'/media-library':AssetsPage,'/inventory':InventoryPage,'/orders':OrdersPage,'/customers':CustomersPage,'/vip-loyalty':VipLoyaltyPage,'/vip-analytics':VipAnalyticsPage,'/finance':FinancePage,'/payments':PaymentsPage,'/delivery':DeliveryPage,'/delivery-cod':DeliveryWorkspacePage,'/delivery-control':DeliveryControlPage,'/promotions':PromotionsPage,'/settings':SettingsPage,'/customer-experience':CustomerExperiencePage,'/theme-system':ThemeSystemPage,'/languages':LanguagesPage,'/address-form':AddressFormPage,'/cs-ai':CustomerServicePage,'/access':AccessPage,'/staff-store-access':StaffStoreAccessPage,'/staff-notifications':StaffNotificationsPage};
